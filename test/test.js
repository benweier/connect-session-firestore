...
describe('Code Standards', function () {
  ...
  lint(['index.js', 'lib/connect-session-firestore.js', 'test/test.js']);
});
...
describe('FirestoreStore', function () {
  ...
  before('set up', function (done) {
    ...
    this.store = new FirestoreStore({
      database: this.firebase.firestore()
    });
  ...
  context('when passed a valid firebase app', function () {
    it('should be an instance of FirestoreStore', function (done) {
      const store = new FirestoreStore({ database: this.firebase });
  ...
  context('when passed a valid firebase database', function () {
    it('should be an instance of FirestoreStore', function (done) {
      const store = new FirestoreStore({ database: this.firebase.firestore() });
  ...
  context('when passed valid arguments', function () {
    it('should be an instance of FirestoreStore', function (done) {
      expect(this.store).to.be.instanceof(FirestoreStore);
      done();
    });
  });
